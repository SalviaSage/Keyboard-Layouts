Devanagari Typer
Version 10 (Kana Version): 2022-03-13
...
This library helps erase some vowel maatra mistakes and replace the maatras 
...
The caps lock key is the "nuqta", it adds a single dot below the letter while the "anusvaar" adds a single dot above the letter.
...
The "Zero-Width Joiner" is located at key "F". It is supposed to help with the conjunct characters, but the viraam seems to do the job just fine most of the time.
...
It doesn't really have all of the Vedic extensions except for the stress symbols like the svarita, udatta and the anudatta which I thought was imporant.
