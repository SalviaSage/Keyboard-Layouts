...
The caps lock key is the "nuqta", adds a single dot below the letter while the "anusvaar" adds a single dot above the letter.
...
Access those by hitting the shift+F, also caps, shift+caps+F.

The "danda" and the "double danda" are at the period key. They serve the same function as the period in the Latin alphabet.

It also has the implosive Sindhi language letters with the line under some of the letters as well.
