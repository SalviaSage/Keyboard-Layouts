...
A particularly difficult script.
...
Consult the "Khmer Keyboard Layout (ScrollLock-Kana-Hold).png" to see a screenshot of these.
...
A note on independent vowels:
https://en.wiktionary.org/wiki/%E1%9E%A4#Khmer
As per this note, the following Unicode character is excluded from this keyboard layout:
