...
https://github.com/SalviaSage/Custom-Libraries/blob/main/Maatra%20Helpers/(Maatra%20Helper)%20Tamil.csv
...
unless if you have the hotstrings.exe program running in the background with my 'Tamil Typer Helper' library loaded and running.
