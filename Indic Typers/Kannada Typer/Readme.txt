...
It is an easy way to type the Kannada script and it does not require retraining your muscle memory.
...
https://github.com/SalviaSage/Custom-Libraries/tree/main/Kannada%20Typer%20Helper
https://github.com/SalviaSage/Custom-Libraries/blob/main/IMEs/IME%20Kannada.csv
...
unless if you have the hotstrings.exe program running in the background with my 'Kannada Typer Helper' library loaded and running.
...
It is used to construct 'conjunct consonants' which of course is an important part of Kannada.
...
It should show appropriately on fonts that are designed for Kannada.

The Rupee sign is also where the dollar sign is. Also if you hit caps lock + 5 you get 'Rs' which is rupees in letters.
