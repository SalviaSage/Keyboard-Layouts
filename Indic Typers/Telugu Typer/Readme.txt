...
It is an easy way to type the Telugu script and it does not require retraining your muscle memory.
...
https://github.com/SalviaSage/Custom-Libraries/tree/main/Telugu%20Typer%20Helper
https://github.com/SalviaSage/Custom-Libraries/blob/main/IMEs/IME%20Telugu.csv
...
unless if you have the hotstrings.exe program running in the background with my 'Telugu Typer Helper' library loaded and running.
...
It is used to construct 'conjunct consonants' which of course is an important part of Telugu.
...
It should show appropriately on fonts that are designed for Telugu.
