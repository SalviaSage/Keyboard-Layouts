...
The historical word separator, the two dot punctuation can be typed by pressing shift+space.
Historical word separator, the ring point can be typed by pressing ctrl+space.
