...
Hitting (D) gives (д | Д) while holding RightAlt gives (δ | Δ) (Greek Letter)
...
Hitting (L) gives (л | Л) while holding RightAlt gives (ᴧ | Λ) (Greek Letter)
Hitting (M) gives (м | М) while holding RightAlt gives (ҝ | Ҝ)
Hitting (O) gives (о | О) while holding RightAlt gives (ө | Ө)
Hitting (P) gives (п | П) while holding RightAlt gives (ӏ | Ӏ) (Palochka)
Hitting (R) gives (р | Р) while holding RightAlt gives (ӗ | Ӗ)
Hitting (T) gives (т | Т) while holding RightAlt gives (ҷ | Ҷ)
