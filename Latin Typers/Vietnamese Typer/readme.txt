...
Press 6 key to type the Vietnamese currency symbol, dong.
...
If we want to preserve the dot above and add more diacritics above it, we can do so by pressing the AltGr+i key and then pressing 1-5 to add the diacritic.
...
The letter (ƀ) is at the AltGr+(b) key.
...
This is better in terms of saving data-size and can have some advantages but also has disadvantages.