...
So, I get around it by typing ᵒ̖ and that isn't a very good solution but it can look good enough.
...
I placed that codepoint into the keyboard, but it will not show it as it is located outside the BMP.
I also placed the modifier letter capital Y in there where it should be.
Only, they would show with some new fonts. We can still type the get-around method by pressing shift+q.
