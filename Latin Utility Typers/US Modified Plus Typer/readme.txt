...
The keyboard features AltGr.
This is done by pressing the right alt key or the ctrl + alt + keys on the keyboard.

From the numpad, we can type superscript numbers by pressing AltGr. 0123456789 | ⁰¹²³⁴⁵⁶⁷⁸⁹
From the numpad, we can type subscript numbers by pressing Ctrl. 0123456789 | ₀₁₂₃₄₅₆₇₈₉
...
AltGr+NumpadPlus types the double prime symbol.

Ctrl+NumpadDot types the degree sign.
AltGr+NumpadDot types the comma for thousands separation.
